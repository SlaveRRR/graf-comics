...
const Login : FC = () => {
    ...
    const {handleSubmit,register,formState:{errors,dirtyFields}} = useForm<FormData>({
        mode:"onChange"
    });
  ...
  return (
    ...
    <div className={cn(styles["login__container"], "container")}>
        ...
        <p className={styles['login__signin']}>Еще нет аккаунта? <Link className={styles['login__link']} href={'/signup'}>Зарегистриуйтесь</Link></p>
    </div>
</section>
  )
}
