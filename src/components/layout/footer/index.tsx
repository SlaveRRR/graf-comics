    ...
    <footer className={styles['footer']}>
      <div className={cn(styles['footer-container'], 'container')}>
        <div className={styles['icons']}>
          ...
          <a href="https://vk.com/graffcomix">
            <svg
              className={styles['footer-icon']}
              width="30"
              height="30"
          ...
          <a href="https://www.tiktok.com/@grafcomix?_t=ZM-8uv3SifuoUf&_r=1">
            <svg
              className={styles['footer-icon']}
              width="30"
              height="30"
        ...
        <div className={styles['links']}>
          ...
          <Link className={styles['links__item']} href="/about">
            Отзывы<span className={styles['dot']}></span>
          </Link>
          <Link className={styles['links__item']} href="/about">
            Почта<span className={styles['dot']}></span>
          </Link>
          <Link className={styles['links__item']} href="/help">
            Помощь<span className={styles['dot']}></span>
          </Link>
          <Link className={styles['links__item']} href="/about">
            Конфиденциальность<span className={styles['dot']}></span>
          </Link>
          <Link className={styles['links__item']} href="/about">
            Реклама<span className={styles['dot']}></span>
          </Link>
          ...
          <Link className={styles['links__item']} href="/author-rights">
            Авторское право<span className={styles['dot']}></span>
          </Link>
          ...
          <Link className={styles['links__item']} href="/policy">
            Политика<span className={styles['dot']}></span>
          </Link>
        ...
        >
          {theme === 'light' ? (
            <img alt="logo-foooter" className={styles['footer-logo']} src="/logo-header.png" />
          ) : (
            <img alt="logo-foooter" className={styles['footer-logo']} src="/logo-header-white.png" />
          )}
        </Link>
      </div>
    </footer>
