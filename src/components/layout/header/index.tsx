    ...
    visibleMenu && (
      <header className={styles['header']}>
        <div className={cn(styles['header-container'], 'container')}>
          {theme === 'light' ? (
            <img src="/logo-header.png" alt="logo" className={styles['logo']} />
          ) : (
            <img src="/logo-header-white.png" alt="logo" className={styles['logo']} />
          )}
          ...
          >
            ...
            <Link onClick={() => setActiveBurger(false)} className={styles['add-comics']} href={'/add-article/images'}>
              Добавить статью
            </Link>
 */}
          </nav>
          ...
          <div className={styles['view-button-mobile']}>
            <BurgerMenu isActive={activeBurger} onClick={handleBurgerClick} />

            {theme === 'light' ? (
              <img src="/search.svg" alt="search" className={styles['search-mobile']} />
            ) : (
              <img src="/search-white.svg" alt="search" className={styles['search-mobile']} />
            )}
          </div>
          <Link href={'/'} className={styles['logo-mobile']}>
          ...
          <div className={styles['view-button-pc']}>
            {theme === 'light' ? (
              <img src="/search.svg" alt="search" className={styles['search-pc']} />
            ) : (
              <img src="/search-white.svg" alt="search" className={styles['search-pc']} />
            )}
