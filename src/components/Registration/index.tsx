...
const Registration = () => {
  ...
  const changeInput = () => {
    if (dirtyFields?.username && !errors?.username) {
      setChange(!change);
    }
  };
    ...
    <section className={styles['registration']}>
      <div className={cn(styles['registration__container'], 'container')}>
        <div className={styles['registration__inner-container']}>
          <div className={styles['registration__inner-box']}>
                ...
                <fieldset className={styles['registration__fieldset']}>
                  ...
                  {change ? (
                    <>
                      ...
                      />
                      <button onClick={changeInput} className={styles['registration__next']} type="button">
                        Далее
                      </button>
                    </>
                  ) : (
                    <>
                      ...
                      <button
                        ...
                        type="button"
                        onClick={handleSubmit(signUpHanlder)}
                      >
                        Готово
                      </button>
                    </>
